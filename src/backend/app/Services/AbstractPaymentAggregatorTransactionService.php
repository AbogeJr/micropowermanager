...
abstract class AbstractPaymentAggregatorTransactionService {
    ...
    public function __construct(
        ...
        private SwiftaTransaction|WaveMoneyTransaction|WaveComTransaction|PaystackTransaction|SafaricomTransaction|SmsTransaction $paymentAggregatorTransaction,
    ) {}
    ...
    public function getPaymentAggregatorTransaction(): SwiftaTransaction|WaveMoneyTransaction|WaveComTransaction|PaystackTransaction|SafaricomTransaction|SmsTransaction {
