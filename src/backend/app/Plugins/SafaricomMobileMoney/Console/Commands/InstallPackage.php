...
use App\Plugins\SafaricomMobileMoney\Services\SafaricomMobileMoneyService;
...
class InstallPackage extends Command {
    ...
    private function publishMigrations() {
        ...
        $this->call('vendor:publish', [
            '--provider' => "App\Plugins\SafaricomMobileMoney\Providers\SafaricomMobileMoneyServiceProvider",
            '--tag' => 'migrations',
        ]);
    }
