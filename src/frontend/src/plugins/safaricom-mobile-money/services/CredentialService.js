...
export class CredentialService {
  constructor() {
    this.credential = {
      // Secrets are write-only from the form's perspective — the backend
      // never returns the stored values, so these stay "" unless the
      // operator types a new value. Blank on submit means "keep current".
      consumerKey: "",
      consumerSecret: "",
      passkey: "",
